...
# $Header: /var/cvsroot/gentoo-x86/dev-util/dmake/dmake-4.12.2.ebuild,v 1.1 2012/05/13 23:59:25 chithanh Exp $
...
src_install () {
	...
	mkdir -p ${D}etc/env.d
	echo "DMAKEROOT=${EPREFIX}/usr/share/startup" >>"${D}etc/env.d/00dmake"
}
