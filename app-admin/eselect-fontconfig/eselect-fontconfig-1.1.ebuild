...
# $Header: /var/cvsroot/gentoo-x86/app-admin/eselect-fontconfig/eselect-fontconfig-1.1.ebuild,v 1.6 2012/04/26 19:20:10 aballier Exp $
...
src_install() {
  cp "${FILESDIR}"/fontconfig.eselect-${PV} "${S}"/fontconfig.eselect-${PV}
