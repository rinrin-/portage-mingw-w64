...
# $Header: /var/cvsroot/gentoo-x86/net-libs/neon/neon-0.29.6-r1.ebuild,v 1.10 2012/05/30 20:04:48 jer Exp $
...
src_configure() {
  ...
  if [[ ${CHOST} == *64*-mingw* ]]; then
       export ne_cv_fmt_ssize_t=lld
       export ne_cv_fmt_size_t=lld
       export ne_cv_fmt_off64_t=lld
       export ne_cv_fmt_time_t=lld
  fi
